...
//        1.3 Verify the text “Cell phones”
        verifyText(By.xpath("//h1[contains(text(),'Cell phones')]"), "Cell phones", getTextFromElement(By.xpath("//h1[contains(text(),'Cell phones')]")));
    }
...
//            2.6 Verify the text “Nokia Lumia 1020”
        verifyText(By.xpath("//h1[contains(text(),'Nokia Lumia 1020')]"), "Nokia Lumia 1020", getTextFromElement(By.xpath("//h1[contains(text(),'Nokia Lumia 1020')]")));
//            2.7 Verify the price “$349.00”
        verifyText(By.xpath("//span[@id='price-value-20']"), "$349.00", getTextFromElement(By.xpath("//span[@id='price-value-20']")));
...
//2.10 Verify the Message "The product has been added to your shopping cart" on Top green Bar
        verifyText(By.xpath("//div[@class=\"bar-notification success\"]/child::p"), "The product has been added to your shopping cart", getTextFromElement(By.xpath("//div[@id='bar-notification']/div[1]/p[1]")));
...
//        2.20 Fill the mandatory fields
        sendingKeyToElement(By.xpath("//input[@id='FirstName']"), "yhudjua");
        sendingKeyToElement(By.xpath("//input[@id='LastName']"), "jmnhg");
...
//        2.27 Fill the Mandatory fields
        sendingKeyToElement(By.id("BillingNewAddress_FirstName"), "Renuka");
        sendingKeyToElement(By.id("BillingNewAddress_LastName"), "Bhrava");
...
//        2.33 Fill all the details
        sendingKeyToElement(By.xpath("//input[@id='CardholderName']"), "jhnbhg");
...
//        2.37 Verify Total is “$698.00”
        verifyText(By.xpath("//tr[@class=\"order-total\"]//span[@class=\"value-summary\"]"), "$698.00", getTextFromElement(By.xpath("//tr[@class=\"order-total\"]//span[@class=\"value-summary\"]")));
...
//        2.40 Verify the message “Your order has been successfully processed!”
        verifyText(By.xpath("//strong[contains(text(),'Your order has been successfully processed!')]"), "Your order has been successfully processed!", getTextFromElement(By.xpath("//strong[contains(text(),'Your order has been successfully processed!')]")));
//        2.41 Click on “CONTINUE”
        clickOnElement(By.xpath("//button[contains(text(),'Continue')]"));
//        2.42 Verify the text “Welcome to our store”
        verifyText(By.xpath("//h2[contains(text(),'Welcome to our store')]"), "Welcome to our store", getTextFromElement(By.xpath("//h2[contains(text(),'Welcome to our store')]")));
